...
$resul=$pdo->prepare('SELECT
MEM.pseudo,
ANN.description_longue,ANN.date_enregistrement,ANN.prix,ANN.adresse,ANN.cp,ANN.ville,ANN.titre,ANN.id_annonce,
CAT.titre,
PHO.url

FROM annonce ANN
INNER JOIN categorie CAT ON CAT.id_categorie=ANN.categorie_id
